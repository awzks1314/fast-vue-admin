...
@click="searchData"
            >搜索</el-button
          >
          <div class="ml20 color-primary cursor" @click="openMore">
            <span class="mr5">{{ openInquire ? '收起' : '展开' }}</span>
            <i
              :class="openInquire ? 'el-icon-arrow-up' : 'el-icon-arrow-down'"
            ></i>
          </div>
        </el-col>
      </el-row>
...
size="medium"
            >新建</el-button
          >
          <el-tooltip class="ml10 cursor" content="刷新" placement="top">
            <i class="el-icon-refresh font20"></i>
          </el-tooltip>
          <el-tooltip class="ml10 cursor" content="布局设置" placement="top">
