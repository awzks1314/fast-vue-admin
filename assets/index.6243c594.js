...
.layout-lock-screen-filter[data-v-10f0f7cc] {
  filter: blur(5px);
}
.layout-lock-screen-mask[data-v-10f0f7cc] {
  background: white;
  z-index: 9999990;
}
.layout-lock-screen-img[data-v-10f0f7cc] {
  background-image: url("https://img6.bdstatic.com/img/image/pcindex/sunjunpchuazhoutu.JPG");
  background-size: 100% 100%;
  z-index: 9999991;
}
.layout-lock-screen[data-v-10f0f7cc] {
  z-index: 9999992;
}
.layout-lock-screen-date[data-v-10f0f7cc] {
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
...
.layout-lock-screen-date-box[data-v-10f0f7cc] {
  position: absolute;
  left: 30px;
  bottom: 50px;
}
.layout-lock-screen-date-box-time[data-v-10f0f7cc] {
  font-size: 100px;
}
.layout-lock-screen-date-box-info[data-v-10f0f7cc] {
  font-size: 40px;
}
.layout-lock-screen-date-box-minutes[data-v-10f0f7cc] {
  font-size: 16px;
}
.layout-lock-screen-login[data-v-10f0f7cc] {
  position: relative;
  z-index: 9999994;
  width: 100%;
  height: 100%;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item[data-v-20393a92] {
  width: 50%;
  height: 70px;
  cursor: pointer;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container[data-v-20393a92] {
  height: 100%;
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-aside-dark[data-v-20393a92] {
  background-color: #b3c0d1;
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-aside[data-v-20393a92] {
  background-color: #d3dce6;
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-header[data-v-20393a92] {
  background-color: #b3c0d1;
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-main[data-v-20393a92] {
  background-color: #e9eef3;
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-circular[data-v-20393a92] {
  border-radius: 2px;
  overflow: hidden;
  border: 1px solid transparent;
  transition: all 0.3s ease-in-out;
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .drawer-layout-active[data-v-20393a92] {
  border: 1px solid;
  border-color: var(--color-primary);
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp[data-v-20393a92],
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp-active[data-v-20393a92] {
  transition: all 0.3s ease-in-out;
  position: absolute;
  left: 50%;
  top: 50%;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp .layout-tips-box[data-v-20393a92],
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp-active .layout-tips-box[data-v-20393a92] {
  transition: inherit;
  width: 30px;
  height: 30px;
  z-index: 9;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp .layout-tips-box .layout-tips-txt[data-v-20393a92],
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp-active .layout-tips-box .layout-tips-txt[data-v-20393a92] {
  transition: inherit;
  position: relative;
  top: 5px;
  font-size: 12px;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .el-circular[data-v-20393a92] {
  transition: all 0.3s ease-in-out;
  border: 1px solid;
  border-color: var(--color-primary);
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .layout-tips-warp[data-v-20393a92] {
  transition: all 0.3s ease-in-out;
  border-color: var(--color-primary);
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .layout-tips-warp .layout-tips-box[data-v-20393a92] {
  transition: inherit;
  border-color: var(--color-primary);
}
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .layout-tips-warp .layout-tips-box .layout-tips-txt[data-v-20393a92] {
  transition: inherit;
  color: var(--color-primary) !important;
  background-color: #e9eef3 !important;
}
.layout-breadcrumb-seting-bar .copy-config[data-v-20393a92] {
  margin: 10px 0;
}
.layout-breadcrumb-seting-bar .copy-config .copy-config-btn[data-v-20393a92] {
  width: 100%;
  margin-top: 15px;
}
.layout-breadcrumb-seting-bar .copy-config .copy-config-last-btn[data-v-20393a92] {
  margin: 10px 0 0;
}`;const v=xe();me("data-v-20393a92");const tt={class:"layout-breadcrumb-seting"},lt={class:"layout-breadcrumb-seting-bar-flex"},nt=t("div",{class:"layout-breadcrumb-seting-bar-flex-label"},"primary",-1),rt={class:"layout-breadcrumb-seting-bar-flex-value"},it={class:"layout-breadcrumb-seting-bar-flex"},at=t("div",{class:"layout-breadcrumb-seting-bar-flex-label"},"success",-1),st={class:"layout-breadcrumb-seting-bar-flex-value"},ct={class:"layout-breadcrumb-seting-bar-flex"},pt=t("div",{class:"layout-breadcrumb-seting-bar-flex-label"},"info",-1),dt={class:"layout-breadcrumb-seting-bar-flex-value"},ut={class:"layout-breadcrumb-seting-bar-flex"},bt=t("div",{class:"layout-breadcrumb-seting-bar-flex-label"},"warning",-1),gt={class:"layout-breadcrumb-seting-bar-flex-value"},mt={class:"layout-breadcrumb-seting-bar-flex"},ft=t("div",{class:"layout-breadcrumb-seting-bar-flex-label"},"danger",-1),xt={class:"layout-breadcrumb-seting-bar-flex-value"},ht={class:"layout-breadcrumb-seting-bar-flex"},_t={class:"layout-breadcrumb-seting-bar-flex-label"},wt={class:"layout-breadcrumb-seting-bar-flex-value"},vt={class:"layout-breadcrumb-seting-bar-flex"},kt={class:"layout-breadcrumb-seting-bar-flex-label"},yt={class:"layout-breadcrumb-seting-bar-flex-value"},Ft={class:"layout-breadcrumb-seting-bar-flex"},Ct={class:"layout-breadcrumb-seting-bar-flex-label"},Et={class:"layout-breadcrumb-seting-bar-flex-value"},zt={class:"layout-breadcrumb-seting-bar-flex"},At={class:"layout-breadcrumb-seting-bar-flex-label"},Bt={class:"layout-breadcrumb-seting-bar-flex-value"},Dt={class:"layout-breadcrumb-seting-bar-flex"},Tt={class:"layout-breadcrumb-seting-bar-flex-label"},It={class:"layout-breadcrumb-seting-bar-flex-value"},St={class:"layout-breadcrumb-seting-bar-flex"},Vt={class:"layout-breadcrumb-seting-bar-flex-label"},Lt={class:"layout-breadcrumb-seting-bar-flex-value"},$t={class:"layout-breadcrumb-seting-bar-flex mt10"},Mt={class:"layout-breadcrumb-seting-bar-flex-label"},jt={class:"layout-breadcrumb-seting-bar-flex-value"},Rt={class:"layout-breadcrumb-seting-bar-flex mt14"},Pt={class:"layout-breadcrumb-seting-bar-flex-label"},Ot={class:"layout-breadcrumb-seting-bar-flex-value"},Yt={class:"layout-breadcrumb-seting-bar-flex mt14"},Ut={class:"layout-breadcrumb-seting-bar-flex-label"},Xt={class:"layout-breadcrumb-seting-bar-flex-value"},Gt={class:"layout-breadcrumb-seting-bar-flex mt14"},Ht={class:"layout-breadcrumb-seting-bar-flex-label"},qt={class:"layout-breadcrumb-seting-bar-flex-value"},Nt={class:"layout-breadcrumb-seting-bar-flex"},Wt={class:"layout-breadcrumb-seting-bar-flex-label"},Zt={class:"layout-breadcrumb-seting-bar-flex-value"},Kt={class:"layout-breadcrumb-seting-bar-flex mt15"},Jt={class:"layout-breadcrumb-seting-bar-flex-label"},Qt={class:"layout-breadcrumb-seting-bar-flex-value"},el={class:"layout-breadcrumb-seting-bar-flex mt15"},ol={class:"layout-breadcrumb-seting-bar-flex-label"},tl={class:"layout-breadcrumb-seting-bar-flex-value"},ll={class:"layout-breadcrumb-seting-bar-flex-label"},nl={class:"layout-breadcrumb-seting-bar-flex-value"},rl={class:"layout-breadcrumb-seting-bar-flex mt15"},il={class:"layout-breadcrumb-seting-bar-flex-label"},al={class:"layout-breadcrumb-seting-bar-flex-value"},sl={class:"layout-breadcrumb-seting-bar-flex mt11"},cl={class:"layout-breadcrumb-seting-bar-flex-label"},pl={class:"layout-breadcrumb-seting-bar-flex-value"},dl={class:"layout-breadcrumb-seting-bar-flex mt15"},ul={class:"layout-breadcrumb-seting-bar-flex-label"},bl={class:"layout-breadcrumb-seting-bar-flex-value"},gl={class:"layout-breadcrumb-seting-bar-flex-label"},ml={class:"layout-breadcrumb-seting-bar-flex-value"},fl={class:"layout-breadcrumb-seting-bar-flex mt15"},xl={class:"layout-breadcrumb-seting-bar-flex-label"},hl={class:"layout-breadcrumb-seting-bar-flex-value"},_l={class:"layout-breadcrumb-seting-bar-flex mt15"},wl={class:"layout-breadcrumb-seting-bar-flex-label"},vl={class:"layout-breadcrumb-seting-bar-flex-value"},kl={class:"layout-breadcrumb-seting-bar-flex mt15"},yl={class:"layout-breadcrumb-seting-bar-flex-label"},Fl={class:"layout-breadcrumb-seting-bar-flex-value"},Cl={class:"layout-breadcrumb-seting-bar-flex mt15"},El={class:"layout-breadcrumb-seting-bar-flex-label"},zl={class:"layout-breadcrumb-seting-bar-flex-value"},Al={class:"layout-breadcrumb-seting-bar-flex mt15"},Bl={class:"layout-breadcrumb-seting-bar-flex-label"},Dl={class:"layout-breadcrumb-seting-bar-flex-value"},Tl={class:"layout-breadcrumb-seting-bar-flex mt15"},Il={class:"layout-breadcrumb-seting-bar-flex-label"},Sl={class:"layout-breadcrumb-seting-bar-flex-value"},Vl={class:"layout-breadcrumb-seting-bar-flex mt15"},Ll={class:"layout-breadcrumb-seting-bar-flex-label"},$l={class:"layout-breadcrumb-seting-bar-flex-value"},Ml={class:"layout-breadcrumb-seting-bar-flex mt15"},jl={class:"layout-breadcrumb-seting-bar-flex-label"},Rl={class:"layout-breadcrumb-seting-bar-flex-value"},Pl={class:"layout-breadcrumb-seting-bar-flex mt15"},Ol={class:"layout-breadcrumb-seting-bar-flex-label"},Yl={class:"layout-breadcrumb-seting-bar-flex-value"},Ul={class:"layout-breadcrumb-seting-bar-flex mt14"},Xl={class:"layout-breadcrumb-seting-bar-flex-label"},Gl={class:"layout-breadcrumb-seting-bar-flex-value"},Hl={class:"layout-breadcrumb-seting-bar-flex mt15"},ql={class:"layout-breadcrumb-seting-bar-flex-label"},Nl={class:"layout-breadcrumb-seting-bar-flex-value"},Wl={class:"layout-breadcrumb-seting-bar-flex mt15"},Zl={class:"layout-breadcrumb-seting-bar-flex-label"},Kl={class:"layout-breadcrumb-seting-bar-flex-value"},Jl={class:"layout-breadcrumb-seting-bar-flex mt15"},Ql={class:"layout-breadcrumb-seting-bar-flex-label"},en={class:"layout-breadcrumb-seting-bar-flex-value"},on={class:"layout-breadcrumb-seting-bar-flex mt15 mb28"},tn={class:"layout-breadcrumb-seting-bar-flex-label"},ln={class:"layout-breadcrumb-seting-bar-flex-value"},nn={class:"layout-drawer-content-flex"},rn=t("aside",{class:"el-aside",style:{width:"20px"}},null,-1),an=t("section",{class:"el-container is-vertical"},[t("header",{class:"el-header",style:{height:"10px"}}),t("main",{class:"el-main"})],-1),sn={class:"layout-tips-box"},cn={class:"layout-tips-txt"},pn=t("header",{class:"el-header",style:{height:"10px"}},null,-1),dn=t("section",{class:"el-container"},[t("aside",{class:"el-aside",style:{width:"20px"}}),t("section",{class:"el-container is-vertical"},[t("main",{class:"el-main"})])],-1),un={class:"layout-tips-box"},bn={class:"layout-tips-txt"},gn=t("header",{class:"el-header",style:{height:"10px"}},null,-1),mn=t("section",{class:"el-container"},[t("section",{class:"el-container is-vertical"},[t("main",{class:"el-main"})])],-1),fn={class:"layout-tips-box"},xn={class:"layout-tips-txt"},hn=t("aside",{class:"el-aside-dark",style:{width:"10px"}},null,-1),_n=t("aside",{class:"el-aside",style:{width:"20px"}},null,-1),wn=t("section",{class:"el-container is-vertical"},[t("header",{class:"el-header",style:{height:"10px"}}),t("main",{class:"el-main"})],-1),vn={class:"layout-tips-box"},kn={class:"layout-tips-txt"},yn={class:"copy-config"};fe();const Fn=v((e,o,i,l,n,u)=>{const d=h("el-divider"),p=h("el-color-picker"),a=h("el-switch"),E=h("el-input-number"),I=h("el-input"),g=h("el-option"),k=h("el-select"),C=h("el-alert"),y=h("el-button"),V=h("el-scrollbar"),H=h("el-drawer");return R(),P("div",tt,[t(H,{title:e.$t("message.layout.configTitle"),modelValue:e.getThemeConfig.isDrawer,"onUpdate:modelValue":o[57]||(o[57]=r=>e.getThemeConfig.isDrawer=r),direction:"rtl","destroy-on-close":"",size:"240px",onClose:e.onDrawerClose},{default:v(()=>[t(V,{class:"layout-breadcrumb-seting-bar"},{default:v(()=>[t(d,{"content-position":"left"},{default:v(()=>[D(s(e.$t("message.layout.oneTitle")),1)]),_:1}),t("div",lt,[nt,t("div",rt,[t(p,{modelValue:e.getThemeConfig.primary,"onUpdate:modelValue":o[1]||(o[1]=r=>e.getThemeConfig.primary=r),size:"small",onChange:o[2]||(o[2]=r=>e.onColorPickerChange("primary"))},null,8,["modelValue"])])]),t("div",it,[at,t("div",st,[t(p,{modelValue:e.getThemeConfig.success,"onUpdate:modelValue":o[3]||(o[3]=r=>e.getThemeConfig.success=r),size:"small",onChange:o[4]||(o[4]=r=>e.onColorPickerChange("success"))},null,8,["modelValue"])])]),t("div",ct,[pt,t("div",dt,[t(p,{modelValue:e.getThemeConfig.info,"onUpdate:modelValue":o[5]||(o[5]=r=>e.getThemeConfig.info=r),size:"small",onChange:o[6]||(o[6]=r=>e.onColorPickerChange("info"))},null,8,["modelValue"])])]),t("div",ut,[bt,t("div",gt,[t(p,{modelValue:e.getThemeConfig.warning,"onUpdate:modelValue":o[7]||(o[7]=r=>e.getThemeConfig.warning=r),size:"small",onChange:o[8]||(o[8]=r=>e.onColorPickerChange("warning"))},null,8,["modelValue"])])]),t("div",mt,[ft,t("div",xt,[t(p,{modelValue:e.getThemeConfig.danger,"onUpdate:modelValue":o[9]||(o[9]=r=>e.getThemeConfig.danger=r),size:"small",onChange:o[10]||(o[10]=r=>e.onColorPickerChange("danger"))},null,8,["modelValue"])])]),t(d,{"content-position":"left"},{default:v(()=>[D(s(e.$t("message.layout.twoTitle")),1)]),_:1}),t("div",ht,[t("div",_t,s(e.$t("message.layout.twoTopBar")),1),t("div",wt,[t(p,{modelValue:e.getThemeConfig.topBar,"onUpdate:modelValue":o[11]||(o[11]=r=>e.getThemeConfig.topBar=r),size:"small",onChange:o[12]||(o[12]=r=>e.onBgColorPickerChange("topBar"))},null,8,["modelValue"])])]),t("div",vt,[t("div",kt,s(e.$t("message.layout.twoMenuBar")),1),t("div",yt,[t(p,{modelValue:e.getThemeConfig.menuBar,"onUpdate:modelValue":o[13]||(o[13]=r=>e.getThemeConfig.menuBar=r),size:"small",onChange:o[14]||(o[14]=r=>e.onBgColorPickerChange("menuBar"))},null,8,["modelValue"])])]),t("div",Ft,[t("div",Ct,s(e.$t("message.layout.twoColumnsMenuBar")),1),t("div",Et,[t(p,{modelValue:e.getThemeConfig.columnsMenuBar,"onUpdate:modelValue":o[15]||(o[15]=r=>e.getThemeConfig.columnsMenuBar=r),size:"small",onChange:o[16]||(o[16]=r=>e.onBgColorPickerChange("columnsMenuBar"))},null,8,["modelValue"])])]),t("div",zt,[t("div",At,s(e.$t("message.layout.twoTopBarColor")),1),t("div",Bt,[t(p,{modelValue:e.getThemeConfig.topBarColor,"onUpdate:modelValue":o[17]||(o[17]=r=>e.getThemeConfig.topBarColor=r),size:"small",onChange:o[18]||(o[18]=r=>e.onBgColorPickerChange("topBarColor"))},null,8,["modelValue"])])]),t("div",Dt,[t("div",Tt,s(e.$t("message.layout.twoMenuBarColor")),1),t("div",It,[t(p,{modelValue:e.getThemeConfig.menuBarColor,"onUpdate:modelValue":o[19]||(o[19]=r=>e.getThemeConfig.menuBarColor=r),size:"small",onChange:o[20]||(o[20]=r=>e.onBgColorPickerChange("menuBarColor"))},null,8,["modelValue"])])]),t("div",St,[t("div",Vt,s(e.$t("message.layout.twoColumnsMenuBarColor")),1),t("div",Lt,[t(p,{modelValue:e.getThemeConfig.columnsMenuBarColor,"onUpdate:modelValue":o[21]||(o[21]=r=>e.getThemeConfig.columnsMenuBarColor=r),size:"small",onChange:o[22]||(o[22]=r=>e.onBgColorPickerChange("columnsMenuBarColor"))},null,8,["modelValue"])])]),t("div",$t,[t("div",Mt,s(e.$t("message.layout.twoIsTopBarColorGradual")),1),t("div",jt,[t(a,{modelValue:e.getThemeConfig.isTopBarColorGradual,"onUpdate:modelValue":o[23]||(o[23]=r=>e.getThemeConfig.isTopBarColorGradual=r),onChange:e.onTopBarGradualChange},null,8,["modelValue","onChange"])])]),t("div",Rt,[t("div",Pt,s(e.$t("message.layout.twoIsMenuBarColorGradual")),1),t("div",Ot,[t(a,{modelValue:e.getThemeConfig.isMenuBarColorGradual,"onUpdate:modelValue":o[24]||(o[24]=r=>e.getThemeConfig.isMenuBarColorGradual=r),onChange:e.onMenuBarGradualChange},null,8,["modelValue","onChange"])])]),t("div",Yt,[t("div",Ut,s(e.$t("message.layout.twoIsColumnsMenuBarColorGradual")),1),t("div",Xt,[t(a,{modelValue:e.getThemeConfig.isColumnsMenuBarColorGradual,"onUpdate:modelValue":o[25]||(o[25]=r=>e.getThemeConfig.isColumnsMenuBarColorGradual=r),onChange:e.onColumnsMenuBarGradualChange},null,8,["modelValue","onChange"])])]),t("div",Gt,[t("div",Ht,s(e.$t("message.layout.twoIsMenuBarColorHighlight")),1),t("div",qt,[t(a,{modelValue:e.getThemeConfig.isMenuBarColorHighlight,"onUpdate:modelValue":o[26]||(o[26]=r=>e.getThemeConfig.isMenuBarColorHighlight=r),onChange:e.onMenuBarHighlightChange},null,8,["modelValue","onChange"])])]),t(d,{"content-position":"left"},{default:v(()=>[D(s(e.$t("message.layout.threeTitle")),1)]),_:1}),t("div",Nt,[t("div",Wt,s(e.$t("message.layout.threeIsCollapse")),1),t("div",Zt,[t(a,{modelValue:e.getThemeConfig.isCollapse,"onUpdate:modelValue":o[27]||(o[27]=r=>e.getThemeConfig.isCollapse=r),onChange:e.onThemeConfigChange},null,8,["modelValue","onChange"])])]),t("div",Kt,[t("div",Jt,s(e.$t("message.layout.threeIsUniqueOpened")),1),t("div",Qt,[t(a,{modelValue:e.getThemeConfig.isUniqueOpened,"onUpdate:modelValue":o[28]||(o[28]=r=>e.getThemeConfig.isUniqueOpened=r),onChange:e.setLocalThemeConfig},null,8,["modelValue","onChange"])])]),t("div",el,[t("div",ol,s(e.$t("message.layout.threeIsFixedHeader")),1),t("div",tl,[t(a,{modelValue:e.getThemeConfig.isFixedHeader,"onUpdate:modelValue":o[29]||(o[29]=r=>e.getThemeConfig.isFixedHeader=r),onChange:e.onIsFixedHeaderChange},null,8,["modelValue","onChange"])])]),t("div",{class:"layout-breadcrumb-seting-bar-flex mt15",style:{opacity:e.getThemeConfig.layout!=="classic"?.5:1}},[t("div",ll,s(e.$t("message.layout.threeIsClassicSplitMenu")),1),t("div",nl,[t(a,{modelValue:e.getThemeConfig.isClassicSplitMenu,"onUpdate:modelValue":o[30]||(o[30]=r=>e.getThemeConfig.isClassicSplitMenu=r),disabled:e.getThemeConfig.layout!=="classic",onChange:e.onClassicSplitMenuChange},null,8,["modelValue","disabled","onChange"])])],4),t("div",rl,[t("div",il,s(e.$t("message.layout.threeIsLockScreen")),1),t("div",al,[t(a,{modelValue:e.getThemeConfig.isLockScreen,"onUpdate:modelValue":o[31]||(o[31]=r=>e.getThemeConfig.isLockScreen=r),onChange:e.setLocalThemeConfig},null,8,["modelValue","onChange"])])]),t("div",sl,[t("div",cl,s(e.$t("message.layout.threeLockScreenTime")),1),t("div",pl,[t(E,{modelValue:e.getThemeConfig.lockScreenTime,"onUpdate:modelValue":o[32]||(o[32]=r=>e.getThemeConfig.lockScreenTime=r),"controls-position":"right",min:0,max:9999,onChange:e.setLocalThemeConfig,size:"mini",style:{width:"90px"}},null,8,["modelValue","onChange"])])]),t(d,{"content-position":"left"},{default:v(()=>[D(s(e.$t("message.layout.fourTitle")),1)]),_:1}),t("div",dl,[t("div",ul,s(e.$t("message.layout.fourIsShowLogo")),1),t("div",bl,[t(a,{modelValue:e.getThemeConfig.isShowLogo,"onUpdate:modelValue":o[33]||(o[33]=r=>e.getThemeConfig.isShowLogo=r),onChange:e.onIsShowLogoChange},null,8,["modelValue","onChange"])])]),t("div",{class:"layout-breadcrumb-seting-bar-flex mt15",style:{opacity:e.getThemeConfig.layout==="classic"||e.getThemeConfig.layout==="transverse"?.5:1}},[t("div",gl,s(e.$t("message.layout.fourIsBreadcrumb")),1),t("div",ml,[t(a,{modelValue:e.getThemeConfig.isBreadcrumb,"onUpdate:modelValue":o[34]||(o[34]=r=>e.getThemeConfig.isBreadcrumb=r),disabled:e.getThemeConfig.layout==="classic"||e.getThemeConfig.layout==="transverse",onChange:e.onIsBreadcrumbChange},null,8,["modelValue","disabled","onChange"])])],4),t("div",fl,[t("div",xl,s(e.$t("message.layout.fourIsBreadcrumbIcon")),1),t("div",hl,[t(a,{modelValue:e.getThemeConfig.isBreadcrumbIcon,"onUpdate:modelValue":o[35]||(o[35]=r=>e.getThemeConfig.isBreadcrumbIcon=r),onChange:e.setLocalThemeConfig},null,8,["modelValue","onChange"])])]),t("div",_l,[t("div",wl,s(e.$t("message.layout.fourIsTagsview")),1),t("div",vl,[t(a,{modelValue:e.getThemeConfig.isTagsview,"onUpdate:modelValue":o[36]||(o[36]=r=>e.getThemeConfig.isTagsview=r),onChange:e.setLocalThemeConfig},null,8,["modelValue","onChange"])])]),t("div",kl,[t("div",yl,s(e.$t("message.layout.fourIsTagsviewIcon")),1),t("div",Fl,[t(a,{modelValue:e.getThemeConfig.isTagsviewIcon,"onUpdate:modelValue":o[37]||(o[37]=r=>e.getThemeConfig.isTagsviewIcon=r),onChange:e.setLocalThemeConfig},null,8,["modelValue","onChange"])])]),t("div",Cl,[t("div",El,s(e.$t("message.layout.fourIsCacheTagsView")),1),t("div",zl,[t(a,{modelValue:e.getThemeConfig.isCacheTagsView,"onUpdate:modelValue":o[38]||(o[38]=r=>e.getThemeConfig.isCacheTagsView=r),onChange:e.setLocalThemeConfig},null,8,["modelValue","onChange"])])]),t("div",Al,[t("div",Bl,s(e.$t("message.layout.fourIsSortableTagsView")),1),t("div",Dl,[t(a,{modelValue:e.getThemeConfig.isSortableTagsView,"onUpdate:modelValue":o[39]||(o[39]=r=>e.getThemeConfig.isSortableTagsView=r),onChange:e.onSortableTagsViewChange},null,8,["modelValue","onChange"])])]),t("div",Tl,[t("div",Il,s(e.$t("message.layout.fourIsFooter")),1),t("div",Sl,[t(a,{modelValue:e.getThemeConfig.isFooter,"onUpdate:modelValue":o[40]||(o[40]=r=>e.getThemeConfig.isFooter=r),onChange:e.setLocalThemeConfig},null,8,["modelValue","onChange"])])]),t("div",Vl,[t("div",Ll,s(e.$t("message.layout.fourIsGrayscale")),1),t("div",$l,[t(a,{modelValue:e.getThemeConfig.isGrayscale,"onUpdate:modelValue":o[41]||(o[41]=r=>e.getThemeConfig.isGrayscale=r),onChange:o[42]||(o[42]=r=>e.onAddFilterChange("grayscale"))},null,8,["modelValue"])])]),t("div",Ml,[t("div",jl,s(e.$t("message.layout.fourIsInvert")),1),t("div",Rl,[t(a,{modelValue:e.getThemeConfig.isInvert,"onUpdate:modelValue":o[43]||(o[43]=r=>e.getThemeConfig.isInvert=r),onChange:o[44]||(o[44]=r=>e.onAddFilterChange("invert"))},null,8,["modelValue"])])]),t("div",Pl,[t("div",Ol,s(e.$t("message.layout.fourIsWartermark")),1),t("div",Yl,[t(a,{modelValue:e.getThemeConfig.isWartermark,"onUpdate:modelValue":o[45]||(o[45]=r=>e.getThemeConfig.isWartermark=r),onChange:e.onWartermarkChange},null,8,["modelValue","onChange"])])]),t("div",Ul,[t("div",Xl,s(e.$t("message.layout.fourWartermarkText")),1),t("div",Gl,[t(I,{modelValue:e.getThemeConfig.wartermarkText,"onUpdate:modelValue":o[46]||(o[46]=r=>e.getThemeConfig.wartermarkText=r),size:"mini",style:{width:"90px"},onInput:o[47]||(o[47]=r=>e.onWartermarkTextInput(r))},null,8,["modelValue"])])]),t(d,{"content-position":"left"},{default:v(()=>[D(s(e.$t("message.layout.fiveTitle")),1)]),_:1}),t("div",Hl,[t("div",ql,s(e.$t("message.layout.fiveTagsStyle")),1),t("div",Nl,[t(k,{modelValue:e.getThemeConfig.tagsStyle,"onUpdate:modelValue":o[48]||(o[48]=r=>e.getThemeConfig.tagsStyle=r),placeholder:"\u8BF7\u9009\u62E9",size:"mini",style:{width:"90px"},onChange:e.setLocalThemeConfig},{default:v(()=>[t(g,{label:"\u98CE\u683C1",value:"tags-style-one"}),t(g,{label:"\u98CE\u683C2",value:"tags-style-two"}),t(g,{label:"\u98CE\u683C3",value:"tags-style-three"}),t(g,{label:"\u98CE\u683C4",value:"tags-style-four"})]),_:1},8,["modelValue","onChange"])])]),t("div",Wl,[t("div",Zl,s(e.$t("message.layout.fiveAnimation")),1),t("div",Kl,[t(k,{modelValue:e.getThemeConfig.animation,"onUpdate:modelValue":o[49]||(o[49]=r=>e.getThemeConfig.animation=r),placeholder:"\u8BF7\u9009\u62E9",size:"mini",style:{width:"90px"},onChange:e.setLocalThemeConfig},{default:v(()=>[t(g,{label:"slide-right",value:"slide-right"}),t(g,{label:"slide-left",value:"slide-left"}),t(g,{label:"opacitys",value:"opacitys"})]),_:1},8,["modelValue","onChange"])])]),t("div",Jl,[t("div",Ql,s(e.$t("message.layout.fiveColumnsAsideStyle")),1),t("div",en,[t(k,{modelValue:e.getThemeConfig.columnsAsideStyle,"onUpdate:modelValue":o[50]||(o[50]=r=>e.getThemeConfig.columnsAsideStyle=r),placeholder:"\u8BF7\u9009\u62E9",size:"mini",style:{width:"90px"},onChange:e.setLocalThemeConfig},{default:v(()=>[t(g,{label:"\u5706\u89D2",value:"columns-round"}),t(g,{label:"\u5361\u7247",value:"columns-card"})]),_:1},8,["modelValue","onChange"])])]),t("div",on,[t("div",tn,s(e.$t("message.layout.fiveColumnsAsideLayout")),1),t("div",ln,[t(k,{modelValue:e.getThemeConfig.columnsAsideLayout,"onUpdate:modelValue":o[51]||(o[51]=r=>e.getThemeConfig.columnsAsideLayout=r),placeholder:"\u8BF7\u9009\u62E9",size:"mini",style:{width:"90px"},onChange:e.setLocalThemeConfig},{default:v(()=>[t(g,{label:"\u6C34\u5E73",value:"columns-horizontal"}),t(g,{label:"\u5782\u76F4",value:"columns-vertical"})]),_:1},8,["modelValue","onChange"])])]),t(d,{"content-position":"left"},{default:v(()=>[D(s(e.$t("message.layout.sixTitle")),1)]),_:1}),t("div",nn,[t("div",{class:"layout-drawer-content-item",onClick:o[52]||(o[52]=r=>e.onSetLayout("defaults"))},[t("section",{class:["el-container el-circular",{"drawer-layout-active":e.getThemeConfig.layout==="defaults"}]},[rn,an],2),t("div",{class:["layout-tips-warp",{"layout-tips-warp-active":e.getThemeConfig.layout==="defaults"}]},[t("div",sn,[t("p",cn,s(e.$t("message.layout.sixDefaults")),1)])],2)]),t("div",{class:"layout-drawer-content-item",onClick:o[53]||(o[53]=r=>e.onSetLayout("classic"))},[t("section",{class:["el-container is-vertical el-circular",{"drawer-layout-active":e.getThemeConfig.layout==="classic"}]},[pn,dn],2),t("div",{class:["layout-tips-warp",{"layout-tips-warp-active":e.getThemeConfig.layout==="classic"}]},[t("div",un,[t("p",bn,s(e.$t("message.layout.sixClassic")),1)])],2)]),t("div",{class:"layout-drawer-content-item",onClick:o[54]||(o[54]=r=>e.onSetLayout("transverse"))},[t("section",{class:["el-container is-vertical el-circular",{"drawer-layout-active":e.getThemeConfig.layout==="transverse"}]},[gn,mn],2),t("div",{class:["layout-tips-warp",{"layout-tips-warp-active":e.getThemeConfig.layout==="transverse"}]},[t("div",fn,[t("p",xn,s(e.$t("message.layout.sixTransverse")),1)])],2)]),t("div",{class:"layout-drawer-content-item",onClick:o[55]||(o[55]=r=>e.onSetLayout("columns"))},[t("section",{class:["el-container el-circular",{"drawer-layout-active":e.getThemeConfig.layout==="columns"}]},[hn,_n,wn],2),t("div",{class:["layout-tips-warp",{"layout-tips-warp-active":e.getThemeConfig.layout==="columns"}]},[t("div",vn,[t("p",kn,s(e.$t("message.layout.sixColumns")),1)])],2)])]),t("div",yn,[t(C,{title:e.$t("message.layout.tipText"),type:"warning",closable:!1},null,8,["title"]),t(y,{size:"small",class:"copy-config-btn",icon:"el-icon-document-copy",type:"primary",ref:"copyConfigBtnRef",onClick:o[56]||(o[56]=r=>e.onCopyConfigClick(r.target))},{default:v(()=>[D(s(e.$t("message.layout.copyText")),1)]),_:1},512)])]),_:1})]),_:1},8,["title","modelValue","onClose"])])});X.render=Fn,X.__scopeId="data-v-20393a92";var Cn=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:X}),Te=he({name:"App",components:{LockScreen:U,Setings:X},setup(){const{t:e}=_e(),{proxy:o}=ee(),i=K(),l=po(),n=Y(),u=we(()=>n.state.themeConfig.themeConfig),d=()=>{i.value.openDrawer()};return so(()=>{Ce.cssCdn(),Ce.jsCdn()}),J(()=>{B(()=>{o.mittBus.on("openSetingsDrawer",()=>{d()}),_.get("themeConfig")&&(n.dispatch("themeConfig/setThemeConfig",_.get("themeConfig")),document.documentElement.style.cssText=_.get("themeConfigStyle"))})}),Q(()=>{o.mittBus.off("openSetingsDrawer",()=>{})}),co(()=>l.path,()=>{B(()=>{let p="";l.path==="/login"?p=l.meta.title:p=e(l.meta.title),document.title=`${p} - ${u.value.globalTitle}`||u.value.globalTitle})}),{setingsRef:i,getThemeConfig:u}}});function En(e,o,i,l,n,u){const d=h("router-view"),p=h("LockScreen"),a=h("Setings");return R(),P(bo,null,[M(t(d,null,null,512),[[j,e.getThemeConfig.lockScreenTime!==0]]),e.getThemeConfig.isLockScreen?(R(),P(p,{key:0})):uo("",!0),M(t(a,{ref:"setingsRef"},null,512),[[j,e.getThemeConfig.lockScreenTime!==0]])],64)}Te.render=En;var Jn=`/* Make clicks pass-through */
#nprogress {
  pointer-events: none;
}
...
.icon-selector-popper .icon-selector-warp .icon-selector-all-tabs-active .label {
  color: #ffffff;
}`;const Ue=_o(Te);Ue.use(w,Ae).use(wo,{i18n:Ye.global.t}).use(T).use(Ye).mount("#app"),Ue.config.globalProperties.mittBus=vo();export{_ as L,z as S,c as _,Ve as a,jo as f,Se as i,se as r,Y as u};
