...
.awesome-container .iconfont-row .iconfont-warp .iconfont-warp-label[data-v-d1bcee14] {
  color: #99a9bf;
  transition: all 0.3s ease;
}`;const c=A();B("data-v-d1bcee14");const D={class:"awesome-container"},E={class:"iconfont-warp"},G={class:"flex-margin"},J={class:"iconfont-warp-value"},M={class:"iconfont-warp-label mt10"};F();const N=c((o,e,n,f,s,a)=>{const v=i("el-col"),b=i("el-row"),u=i("el-card");return l(),d("div",D,[t(u,{shadow:"hover",header:`fontawesome \u5B57\u4F53\u56FE\u6807(\u81EA\u52A8\u8F7D\u5165)\uFF1A${o.sheetsIconList.length-24}\u4E2A`},{default:c(()=>[t(b,{class:"iconfont-row"},{default:c(()=>[(l(!0),d(T,null,q(o.sheetsIconList,(r,y)=>(l(),d(v,{xs:12,sm:8,md:6,lg:4,xl:2,key:y,onClick:R=>f.copy(r),class:"copy"},{default:c(()=>[t("div",E,[t("div",G,[t("div",J,[t("i",{class:[r,"fa"]},null,2)]),t("div",M,z(r),1)])])]),_:2},1032,["onClick"]))),128))]),_:1})]),_:1},8,["header"])])});p.render=N,p.__scopeId="data-v-d1bcee14";export default p;
